...
The feature requires GitHub CLI (`gh`) authentication for the selected
GitHub.com or Enterprise host. It never accepts GraphQL from the renderer,
does not expose credentials, and does not create, edit, close, or otherwise
