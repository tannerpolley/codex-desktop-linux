...
JS
    ...
    assert_contains "$extracted/.vite/build/comment-preload.js" '??document.getElementById(Zl)'
    ...
    assert_occurrence_count "$extracted/.vite/build/comment-preload.js" 'document.getElementById(Zl)' '1'
